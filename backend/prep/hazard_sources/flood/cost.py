...
⚠️ **これは仮の値。** 「この深さなら何倍歩きにくいか」に理論的な裏付けは無く、
0.3m を歩行困難ライン、1.0m 超を通行不可として組んだ初期値。
変えるときは、経路の距離差が妥当な範囲（10〜30%）に収まるかを
確認してからにすること。変更したら変更前後の値と理由をここに残す。
"""
